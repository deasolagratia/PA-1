...
<body>
	<header>
		<h1>ULOS HARUNGGUAN</h1>
		<h2>ᯥᯞ᯲oᯘ᯲ ᯂᯒᯮᯰᯎᯮᯀᯉ᯲</h2>
	</header>
	<div class="sidebar">
			...
			<div class="article">
				<div class="kiri">
					...
					<p>
						...
						<p>
							<a
									href="https://www.del.ac.id/people/arlinta/files/09a_artepolis_paper.pdf">https://www.del.ac.id/people/arlinta/files/09a_artepolis_paper.pdf</a></p>
						</dd>
					</p>
				</div>
				<div class="kanan">
					<p>Memiliki makna Marunggu (berkumpul). Digunakan pada acara sukacita dan dukacita, Seperti
						meminta
						doa restu untuk kesuksesan. Digunakan Oleh Laki-laki dan perempuan.</p>
					<p>Ulos jenis ini memiliki kombinasi dari semua jenis ulos lainnya. Ulos jenis ini hanya boleh
						digunakan oleh wanita yang sudah menikah. Harga Ulos jenis ini relatif lebih mahal
						dibandingkan
						dengan jenis Ulos lainnya karena kaya akan corak sehingga membutuhkan usaha lebih dari para
						penenun untuk memproduksi Ulos jenis ini.</p>
					<p>Kain ini memiliki makna dan nilai simbolis yang penting dalam budaya Batak Toba. Ulos
						Harungguan
						sering digunakan dalam berbagai upacara adat seperti pernikahan, pemakaman, dan acara
						keagamaan.
						Kain ini juga sering dijadikan sebagai hadiah dalam rangkaian acara adat.</p>
					<p>Ulos Harungguan memiliki ciri khas berupa hiasan bordir yang rumit dan indah, dengan
						warna-warna
						cerah dan motif-motif yang menggambarkan kehidupan dan kepercayaan masyarakat Batak Toba.
						Motif
						yang umum ditemukan dalam Ulos Harungguan antara lain motif burung, ikan, tumbuhan, dan
						manusia.
					</p>
				</div>
			</div>
