...
<body>
	<header>
		<h1>ULOS RAGI HUTING</h1>
		<h2>ᯥᯞ᯲oᯘ᯲ ᯒᯎᯪ ᯂᯮᯖᯪᯰ</h2>
	</header>
	<div class="sidebar">
			...
			<div class="article">
				<div class="kiri">
					<div class='slide'>
						...
						<img src='ulos/ragihuting1.jpg' />
						<input type='radio' name='radio-set' checked='checked' />
						<img src='ulos/ragihuting2.png' />
					</div>
					<p>
					...
					<p>
						<dd><b>Referensi: </b>
							<p>Buku Pesona Kain Ulos Danau Toba (Threes Emir & Samuel Wattimena)</p>
							<p><a
									href="https://journal.unilak.ac.id/index.php/jib/article/download/9466/3754">https://journal.unilak.ac.id/index.php/jib/article/download/9466/3754</a>
							</p>
						</dd>
					</p>
				</div>
				<div class="kanan">
					<p>Ulos Ragi Huting biasa dipakai sebagai penutup punggung Wanita (selendang) atau dililitkan pada
						dada (kemben). Ulos ini memiliki makna sukacita, disebut Ragi Huting karena bitnik-bintik pada
						ulos seperti bulu kucing. Ulos ini dapat digunakan oleh laki-laki dan perempuan (semua
						kalangan).</p>
					...
					<p>Kain ini juga melambangkan kesuburan, kelimpahan, dan kehidupan yang berkelanjutan. Motif Huting
						yang terdiri dari garis-garis melintang menggambarkan pertumbuhan dan perjalanan kehidupan. Ulos
						Ragi Huting juga sering dianggap sebagai simbol perlindungan, keberuntungan, dan keselamatan.
					</p>
					<p>Ulos yang digunakan oleh gadis Batak yang dililitkan di bagian dada, atau juga oleh orang tua
						yang sedang berpergian. Ulos ini sudah jarang ditemukan saat ini.</p>
				</div>
			</div>
		</div>
		<br>
