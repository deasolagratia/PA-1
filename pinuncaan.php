...
<body>
	<header>
		<h1>ULOS PINUNCAAN</h1>
		<h2>ᯥᯞ᯲oᯘ᯲ ᯇᯪᯉᯮᯉ᯲ᯘᯀᯉ᯲</h2>
	</header>
	<div class="sidebar">
			...
			<div class="article">
				<div class="kiri">
					<div class='slide'>
						...
						<img src='ulos/pinunsaan1.png' />
						<input type='radio' name='radio-set' checked='checked' />
						<img src='ulos/pinunsaan2.jpg' />
					</div>
					<p>
				...
				<div class="kanan">
					<p>Ulos Pinuncaan digunakan oleh tuan rumah atau pelaksana upacara adat sebagai baju keluarga tuan
						rumah dalam upacara <b>Marpaniaran</b>. Ulos ini memiliki makna dukacita dan sukacita tergantung
						pada acara yang dihadiri. Ulos ini digunakan oleh seluruh anggota keluarga (laki-laki dan
						perempuan).</p>
					<p>Kain ini melambangkan keberanian, kekuatan, dan kehormatan. Ulos Pinuncaan juga sering dianggap
						sebagai simbol kesuburan, kesejahteraan, dan keberuntungan. Kain ini juga mengandung makna
						spiritual dan kepercayaan yang dalam dalam kehidupan suku Batak.</p>
					<p>Ulos yang paling mahal pada masyarakat Batak. Ulos ini terdiri dari lima bagian yang ditenun
						secara terpisah dan kemudian disatukan. Fungsi dari ulos ini digunakan saat suka maupun duka
						dengan mematuhi syaratsyarat tertentu.</p>
				</div>
			</div>
		</div>
		<br>
