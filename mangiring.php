		...
		<div class="container">
			<div class="article">
				<div class="kiri">
					...
					<p>
						<dd><b>Referensi:</b> 
							<p><a href="https://journal.unilak.ac.id/index.php/jib/article/download/9466/3754">https://journal.unilak.ac.id/index.php/jib/article/download/9466/3754</a></p>
						</dd>
					</p>
				</div>
				<div class="kanan">
					<p>Ulos Mangiring diberikan oppung saat kelahiran cucu pertamanya dengan harapan agar cucu
						berikutnya lahir beriringan. Ulos ini memiliki makna agar cucu lahirnya secara beriringan. Sang
						cucu pertama dapat membimbing adik-adiknya. Dan ulos inin digunakan oleh anak bayi.</p>
					<p>Ulos Mangiring memiliki makna dan simbolik yang kaya, dan biasanya digunakan dalam acara-acara
						adat, upacara keagamaan, pernikahan, dan acara penting lainnya. Kain ini melambangkan
						keberanian, kekuatan, kemakmuran, dan kebahagiaan. Ulos Mangiring juga sering dianggap sebagai
						lambang kemurnian, kesucian, dan keberkahan dalam kehidupan sehari-hari, serta sebagai simbol
						identitas budaya suku Batak Toba.</p>
					<p>Motifnya terdiri dari garis-garis melintang, zigzag, dan bentuk-bentuk geometris lainnya yang
						saling terkait. Warna yang dominan dalam Ulos Mangiring adalah merah, hitam, dan putih, dengan
						tambahan aksen warna-warna cerah lainnya seperti kuning, hijau, dan biru.</p>
					<p>Ulos yang sering diberikan kepada anak pertama yang baru lahir. Ulos ini bermakna agar anak
						tersebut kelak dapat membimbing adik-adiknya sesuai dengan harapan dan tradisi keluarga Batak.
					</p>
				</div>
			</div>
		</div>
