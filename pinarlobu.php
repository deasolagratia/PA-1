...
<body>
	<header>
		<h1>ULOS PINARLOBU-LOBU</h1>
		<h2>ᯥᯞ᯲oᯘ᯲ ᯇᯪᯉᯒ᯲ᯞ᯲oᯅᯮ-ᯞ᯲oᯅᯮ</h2>
	</header>
	<div class="sidebar">
	...
	<main>
		<div class="container">
			<div class="article">
				...
				<div class="kanan">
					<p>Ulos Pinarlobu-lobu adalah kain ulos yang digunakan sebagai kain hohop (penutup tubuh bagian
						atas). Digunakan oleh tuan rumah pelaksana upacara adat.Ulos ini memiliki makna Sukacita. Dan
						digunakan oleh laki-laki dan perempuan.</p>
					<p>Motif Lobu Lobu adalah motif bunga dengan empat kelopak yang secara simbolis melambangkan empat
						elemen alam semesta: tanah, air, angin, dan api. Warna yang dominan dalam Ulos Pinar Lobu Lobu
						adalah merah, hitam, dan putih, dengan tambahan aksen warna-warna cerah lainnya seperti kuning,
						hijau, dan biru.</p>
					<p>Kain ini melambangkan keindahan alam, kehidupan, kesuburan, dan kebahagiaan. Lobu Lobu sebagai
						motif bunga mewakili siklus kehidupan dan keabadian. Ulos Pinar Lobu Lobu juga sering dianggap
						sebagai simbol perlindungan dan keberkahan dalam kehidupan sehari-hari, serta sebagai simbol
						identitas budaya suku Batak.</p>
				</div>
			</div>
		</div>
		<br>
